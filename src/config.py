...
STATUS_PORT = int(os.getenv("STATUS_PORT") or 8000)

DOCKER_MAX_WORKERS = int(os.getenv("DOCKER_MAX_WORKERS") or 2)

SHUTDOWN_DELAY = int(os.getenv("SHUTDOWN_DELAY") or 300)
...
ANNOUNCE_CHANNEL_ID = int(os.getenv("ANNOUNCE_CHANNEL_ID") or 0)

ANNOUNCE_ROLE_ID = int(os.getenv("ANNOUNCE_ROLE_ID") or 0)
